    ...
    return (
        <div className="relative h-dvh w-screen overflow-x-hidden">
            ...
            <div id="video-frame" className="relative z-10 h-dvh w-screen overflow-x-hidden rounded-lg bg-blue-75">
                <div>
                    <div
                        ...
                        <div
                            ...
                            className="origin-center scale-15 opacity-0 transition-all duration-500 ease-in hover:scale-100 hover:opacity-100">
                            <video
                                ref={nextVideoRef}
                ...
                <div className="absolute lef-0 top-0 z-40 size-full">
                    <div className="mt-24 px-5 sm:px-10">
                        <h1 className="special-font hero-heading text-blue-100">
                            redefin<b>e</b>
                        </h1>
                        <p className="mb-5 max-w-64 font-robert-regular text-blue-100">
                            Enter the Metagame Layer <br/> Unleash the power of the blockchain
                        </p>
                        <Button
                            id="watch-trailer"
                            title="Watch Trailer"
